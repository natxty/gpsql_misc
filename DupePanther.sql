...
WHERE
	informationtype.name in ( 'Customer Service', 'Technical Support', 'Locations', 'Sales and Distribution')
	AND
	productservicetype.name = 'Instrument Systems'
	AND 
	productservicename.name = 'TIGRIS DTS System'
...
BEGIN   --Get the Id of the first row
		...
		INSERT INTO informationtype_productservicetype_to_productservicename
			(informationtype_productservicetype_id, productservicename_id, us, gl, both)
		VALUES 
			(@informationtype_productservicetype_id, @productservicename_id, @us, @gl, @both)
		...
		INSERT INTO informationtype_productservicetype_productservicename_to_location
			(informationtype_productservicetype_productservicename_id, location_id, us, gl, both)
		VALUES
			(@informationtype_productservicetype_productservicename_id, @location_id, @us, @gl, @both)
