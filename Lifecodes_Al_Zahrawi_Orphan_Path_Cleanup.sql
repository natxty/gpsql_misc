...
WHERE
	...
	AND
	productserviceline.name IN  ('LIFECODES Transfusion Medicine', 'LIFECODES Transplant Products')
GROUP BY 
	productservicename.id
...
WHERE
	...
	--- AND
	--- informationtype_productserviceline_productservicename_location_to_contact.contact_id IS NULL

SELECT * FROM @tbl2

'''
-- to doublecheck:
SELECT * FROM informationtype_productserviceline_productservicename_to_location
WHERE
	informationtype_productserviceline_productservicename_to_location.id
	IN
		(
...
(
	SELECT informationtype_productserviceline_productservicename_location_id FROM @tbl2 
)
...
WHERE
	...
	AND
	informationtype_productservicetype_productservicename_location_to_contact.contact_id IS NULL
...
(
	SELECT informationtype_productservicetype_productservicename_location_id FROM @tbl2 
)
